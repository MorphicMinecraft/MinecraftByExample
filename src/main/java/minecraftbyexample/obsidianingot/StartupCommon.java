package minecraftbyexample.obsidianingot;
...
{
  public static ItemObsidianingot itemObsidianingot;  // this holds the unique instance of your block
  ...
  public static void preInitCommon()
  {
    ...
    //  +-----------------------+-----------------------+
    //
    itemObsidianingot = (ItemObsidianingot) (new ItemObsidianingot().setUnlocalizedName("obsidian_ingot_unlocalised_name"));
    itemObsidianingot.setRegistryName("obsidian_ingot_registry_name");
    GameRegistry.register(itemObsidianingot);
  }
